...
class Gait_Baseline(nn.Module):
    def __init__(self, model_cfg):
        super(Gait_Baseline, self).__init__()
...
class GaitApp_Baseline(BaseModel):
    def build_network(self, model_cfg):
        self.gaitrecog = Gait_Baseline(model_cfg)
        print("GaitApp_Baseline")
    ...
    def forward(self, inputs, inputs_original=None):
        ...
        if inputs_original == None:
            ...
            test_embs, test_logits = self.gaitrecog(inputs)
            ...
            original_embs, original_logits = self.gaitrecog(inputs_original)
            ...
            cross_embs, cross_logits = self.gaitrecog(cross_cloth_fake_inputs)    
