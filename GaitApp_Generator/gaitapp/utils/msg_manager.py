    ...
    def write_to_tensorboard(self, summary):
        ...
        for k, v in summary.items():
            ...
            if 'image' in module_name:
                if board_name == 'visual_branch_1' or board_name == 'visual_branch_3_NM_to_CL' or board_name == 'visual_branch_3_CL_to_NM' or board_name == 'visual_branch_4_recycle' or board_name == 'visual_triplet':
                    v = vutils.make_grid(v, normalize=True, scale_each=True, nrow=10)
                elif board_name == 'visual_branch_GEI_3_NM_to_CL' or board_name == 'visual_branch_GEI_3_CL_to_NM':
                    v = vutils.make_grid(v, normalize=True, scale_each=True, nrow=8)
            else:
                v = v
